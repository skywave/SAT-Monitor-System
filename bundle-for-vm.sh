...
docker save sat-monitor-system_notification-collector -o "$BUNDLE_DIR/notification-collector.tar"
...
cp Collector/.env "$BUNDLE_DIR/.env.notification-collector"
...
# Create directories
mkdir -p collectorService/collector Collector NotificationSystem

# Restore .env files
cp .env.main-collector collectorService/collector/.env
cp .env.notification-collector Collector/.env
cp .env.notifications NotificationSystem/.env

# Load Docker images
echo "Loading Docker images..."
docker load < main-collector.tar
docker load < notification-collector.tar
